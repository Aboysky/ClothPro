package com.example.clothproject.constant;
...
public interface ResultCode {
     ...
     * 必要参数不能为空
     */
    public static final int NECESSARY_PARAMETER_NOT_NULL_OR_NOTIING = 601;

    /**
     * 必要参数不符合要求(类型或者格式)
     */
    public static final int NECESSARY_PARAMETER_TYPE_OR_FORMAT_ERROR = 602;

    /**
     * 待创建的资源已经存在
     */
    public static final int COMMIT_RESOURCE_HAD_EXIST = 603;

    /**
     * 需要的资源不存在
     */
    public static final int RESOURCE_NOT_EXIST = 604;
